...
```
# 18. Copy one list into another using copy().
```python
list1 = [10, 20, 30]
...
print(numbers)
```
# 20. Sort a list in ascending order using sort().
```python
...
print(numbers)
```
# Type Conversion – Program Questions

## 01. Write a program to add an integer and a float and display the result.
```python
num1 = 12
b=5.5
result = num1+b
print("Result",result) # Output Result 17.5
```
